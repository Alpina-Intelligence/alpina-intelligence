...
export const nhlTeams = pgTable("nhl_teams", {
	...
	conferenceAbbrev: text("conference_abbrev").notNull(),
	division: text("division").notNull(),
	divisionAbbrev: text("division_abbrev").notNull(),
...
export const nhlStandings = pgTable(
	"nhl_standings",
	{
		id: text("id").primaryKey(), // "{seasonId}-{teamAbbrev}"
...
export const nhlSkaterSeasonStats = pgTable(
	...
	{
		id: text("id").primaryKey(), // "{playerId}-{season}-{gameType}"
...
export const nhlSkaterAdvancedStats = pgTable(
	...
	{
		id: text("id").primaryKey(), // "{playerId}-{seasonId}-{gameTypeId}"
		playerId: integer("player_id")
			.notNull()
			.references(() => nhlPlayers.id),
		seasonId: integer("season_id").notNull(),
